...
<div class="page-wrapper">
      <div class="content container-fluid">
            ...
            <form method="POST" action="<?php echo e(route('update.position', ['id' => $position->id])); ?>" class="forms-sample" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                        <div class="col-md-12">
                              <div class="card">
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e($position->name); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YOUNESS-DEVL\Desktop\scasco_reports\resources\views/positions/edit_position.blade.php ENDPATH**/ ?>