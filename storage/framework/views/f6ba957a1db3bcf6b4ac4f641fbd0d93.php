...
<style>
    .flatpickr-day.appointment-highlight {
...
<div class="row project-wrapper">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                <p class="text-uppercase fw-medium text-muted text-truncate mb-3">Affaires</p>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-uppercase fw-medium text-muted mb-3">Comptes Rendus</p>
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value"
                ...
                <div class="card card-animate">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                <p class="text-uppercase fw-medium text-muted text-truncate mb-3">Rendez-Vous</p>
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value"
    ...
    <div class="card">
        <div class="card-header border-0">
            <h4 class="card-title mb-0">Calendrier des rendez-vous</h4>
        </div><!-- end cardheader -->
        <div class="card-body pt-0">
            <div class="calendrier-des-rendez-vous">
                <input id="calendar" type="text" class="form-control" data-provider="flatpickr" data-inline="true">
            </div>

            <h6 class="text-uppercase fw-semibold mt-4 mb-3 text-muted">Rendez-vous:</h6>

            <?php $__currentLoopData = $appointments->sortByDesc('created_at')->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mini-stats-wid d-flex align-items-center mt-3">
                <div class="flex-shrink-0 avatar-sm">
                    <span class="mini-stat-icon avatar-title rounded-circle text-success bg-success-subtle fs-4">
                        <?php echo e(\Carbon\Carbon::parse($appointment->date_appointment)->format('d')); ?>

                    </span>
                </div>
                <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1"><?php echo e($appointment->place); ?></h6>
                    <p class="text-muted mb-0"><?php echo e($appointment->client->client_first_name); ?></p>
                </div>
                <div class="flex-shrink-0">
                    <p class="text-muted mb-0">
                        <?php echo e(\Carbon\Carbon::parse($appointment->date_appointment)->format('h:i a')); ?>
            ...
            <div class="mt-3 text-center">
                <a href="<?php echo e(route('all.appointments')); ?>" class="text-muted text-decoration-underline">Voir toutes les rendez-vous</a>
            </div>
        </div><!-- end cardbody -->
    </div><!-- end card -->
</div><!-- end col -->
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const appointments = <?php echo json_encode($appointments, 15, 512) ?>;

        // Extract appointment dates in 'Y-m-d' format
        const appointmentDates = appointments.map(app => app.date_appointment);

        flatpickr("#calendar", {
            inline: true,
            dateFormat: "Y-m-d",
            defaultDate: appointmentDates,
            onDayCreate: function(dObj, dStr, fp, dayElem) {
                const dateStr = dayElem.dateObj.toISOString().split('T')[0];
                if (appointmentDates.includes(dateStr)) {
                    dayElem.classList.add('appointment-date');
                }
            }
        });
    });
