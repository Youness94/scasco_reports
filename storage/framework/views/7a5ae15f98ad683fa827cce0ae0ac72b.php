...
<?php echo app('translator')->get('Détails de Rendez-Vous'); ?>
...
<?php $__env->slot('li_1'); ?> <a href="<?php echo e(route('all.appointments')); ?>">Tableau de Bord</a> <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Détails de Rendez-Vous <?php $__env->endSlot(); ?> <?php echo $__env->renderComponent(); ?>
<div class="row">
    <div class="col-xxl-3">
