                        ...
                        <form method="POST" action="<?php echo e(route('quote.infos.bulk.status.update')); ?>" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="row g-4 m-2">
                                <div class="col-md-4 mb-3">
                                    <select name="bulk_status" id="bulk_status" class="form-control <?php $__errorArgs = ['bulk_status'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    <textarea name="bulk_note" class="form-control <?php $__errorArgs = ['bulk_note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter note for all selected quotes" required></textarea>
                                    <?php $__errorArgs = ['bulk_note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YOUNESS-DEVL\Desktop\scasco-ANCFCC-devis\resources\views/quotes/quotes_status_pending.blade.php ENDPATH**/ ?>