...
<?php echo app('translator')->get('Créer branche'); ?>
...
<?php $__env->slot('title'); ?> Créer Branche <?php $__env->endSlot(); ?>
...
<div class="page-wrapper">
      <div class="content container-fluid">
            ...
            <form method="POST" action="<?php echo e(route('store.branche')); ?>" class="forms-sample" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                        <div class="col-md-12">
                              <div class="card">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YOUNESS-DEVL\Desktop\scasco_reports\resources\views\branches\add_branche.blade.php ENDPATH**/ ?>