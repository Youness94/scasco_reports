...
<?php echo app('translator')->get('Les utilisateurs'); ?>
...
<?php $__env->slot('title'); ?> List des utilisateur  <?php $__env->endSlot(); ?>
                ...
                <div class="card">
                    ...
                    <div class="row g-4 m-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="<?php echo e(route('add.client.user')); ?>" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Ajouter</a>
                    ...
                    <div class="card-body">
                        <?php if(!empty($client_users) && count($client_users) > 0): ?>
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $client_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a href="<?php echo e(route('edit.client.user',$list->id)); ?>" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                    ...
                    <?php else: ?>
                    <p style="text-align: center;">Aucun client disponible.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YOUNESS-DEVL\Desktop\scasco-ANCFCC-devis\resources\views/client_users/client_users.blade.php ENDPATH**/ ?>