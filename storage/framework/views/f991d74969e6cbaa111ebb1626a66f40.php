...
<?php echo app('translator')->get('Modifier rendez-Vous'); ?>
...
<?php $__env->slot('li_1'); ?> <a href="<?php echo e(route('all.clients')); ?>">Les Rendez-Vous</a> <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Modifier Rendez-Vous <?php $__env->endSlot(); ?>
...
<div class="page-wrapper">
      <div class="content container-fluid">
            ...
            <form method="POST" action="<?php echo e(route('update.appointment', ['id' => $appointment->id])); ?>" class="forms-sample" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                        <div class="col-md-12">
                              <div class="card">
...
unset($__errorArgs, $__bag); ?>" name="potencial_case_id">
                                                                  ...
                                                                  <option value="<?php echo e($potential_case->id); ?>" <?php echo e(old('potencial_case_id',$appointment->potential_case->potencial_case_id) == $potential_case->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="client_id" id="client_id" value="<?php echo e($appointment->potential_case->client->client_first_name); ?> <?php echo e($appointment->potential_case->client->client_first_name); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" name="place" value="<?php echo e($appointment->place); ?>">
...
unset($__errorArgs, $__bag); ?>" name="date_appointment" value="<?php echo e(old('date_appointment', \Carbon\Carbon::parse($appointment->date_appointment)->format('Y-m-d'))); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\YOUNESS-DEVL\Desktop\scasco_reports\resources\views\appointments\edit_appointment.blade.php ENDPATH**/ ?>