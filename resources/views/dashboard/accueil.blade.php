...
<div class="row project-wrapper">
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            ...
            @foreach($appointments->sortByDesc('created_at')->take(5) as $appointment)
            <div class="mini-stats-wid d-flex align-items-center mt-3">
                <div class="flex-shrink-0 avatar-sm">
                    <span class="mini-stat-icon avatar-title rounded-circle text-success bg-success-subtle fs-4">
                        {{ \Carbon\Carbon::parse($appointment->date_appointment)->format('d') }}
                    </span>
                </div>
                <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">{{ $appointment->place }}</h6>
                    <p class="text-muted mb-0">{{ $appointment->client->client_first_name }}</p>
                </div>
                <div class="flex-shrink-0">
                    <p class="text-muted mb-0">
                        {{ \Carbon\Carbon::parse($appointment->date_appointment)->format('h:i a') }}
                    </p>
                </div>
            </div><!-- end -->
            @endforeach
            ...
            <div class="mt-3 text-center">
                <a href="{{ route('all.appointments') }}" class="text-muted text-decoration-underline">Voir toutes les rendez-vous</a>
            </div>
        </div><!-- end cardbody -->
    </div><!-- end card -->
</div><!-- end col -->
