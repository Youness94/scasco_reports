...
@slot('li_1') <a href="{{ route('all.positions') }}">Les Positions</a> @endslot
@slot('title') Créer Position @endslot
@endcomponent
...
<div class="page-wrapper">
      <div class="content container-fluid">
            ...
            <form method="POST" action="{{ route('store.position') }}" class="forms-sample" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                        <div class="col-md-12">
                              <div class="card">
