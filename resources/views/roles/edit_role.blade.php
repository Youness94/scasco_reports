...
@slot('title') Modifier Role @endslot
@endcomponent
                  ...
                  <!-- <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 col-sm-6 col-12 d-flex flex-column justify-content-center">
                              <ul class="breadcrumb ml-auto">
                                    <li class="breadcrumb-item"><a href="{{ route('all.roles') }}">Liste des Roles</a></li>
                        ...
                        <div class="card">
                              <div class="card-body d-flex flex-column">
                                    <div class="live-preview flex-grow-1">
                                          <form method="POST" action="{{ route('update.role', ['id' => $role->id]) }}" class="forms-sample" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
