...
@slot('title') List des utilisateur  @endslot
@endcomponent 
                ...
                <div class="card">
                    ...
                    <div class="row g-4 m-3">
                        <div class="col-sm-auto">
                            <div>
                                <a href="{{ route('add.client.user') }}" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Ajouter</a>
                    ...
                    <div class="card-body">
                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($client_users as $key=>$list )
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a href="{{route('edit.client.user',$list->id)}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
