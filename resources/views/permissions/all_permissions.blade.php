...
@slot('title') List des permissions @endslot
@endcomponent
        ...
        <div class="page-header mb-3 mb-lg-4 mt-3">
            <!-- <div class="row align-items-center">
                <div class="col-xl-8 col-sm-6 col-12 d-flex flex-column justify-content-center">
                    <h3 class="page-title">Liste des Permissions</h3>
                </div>
            ...
            <div class="col-lg-8 ">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Liste des Permissions</h4>
                    </div><!-- end card header -->
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('add.permission') }}" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Ajouter</a>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light ">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <th class="sort" data-sort="phone">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody class="list form-check-all">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <td class="customer_name">{{ $permission->id  }}</td>
                                            <td class="email">{{ $permission->name  }}</td>
                                            <td class="email">{{ $permission->permission_cat  }}</td>
                                            <td>
                                                <div class="d-flex gap-2  justify-content-center">
                                                    <div class="edit">
                                                        @can('update permission')
                                                        <a href="{{route('edit.permission',$permission->id)}}" class="btn btn-success">
                                                            Edit
                                                        </a>
                                                        @endcan
                                                    </div>
                                                    <div class="edit">
                                                        ...
                                                        <a href="{{route('delete.permission',$permission->id)}}" class="btn btn-danger mx-2">
                                                            Delete
                                                        </a>
                                                        @endcan
                                                    </div>
