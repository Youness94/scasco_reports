                        ...
                        <div class="card-header d-flex flex-column">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 d-flex justify-content-end"> 
                                    <a href="{{ route('add.service') }}" class="btn btn-success add-btn"><i class="ri-add-line align-bottom me-1"></i> Ajouter</a> <!-- Remove padding from button -->
                                </div>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="{{route('edit.service',$service->id)}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Modifier</a></li>
                                                    <li><a href="{{route('delete.service',$service->id)}}" class="dropdown-item edit-item-btn"><i class="ri-delete-bin-2-fill align-bottom me-2 text-muted"></i> Supprimer</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
